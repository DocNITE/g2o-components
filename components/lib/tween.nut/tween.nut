...
#public:
    ...
    // NOTE: We should use use nativily easing raw call and checking from 'Tween.easing'
    ...
    static function onRender(dt) {
        ...
        for (local i = 0; i < count; i++) {
            ...
            if (result) {
                // NOTE: We should add function ptr event from constructor
...
// interpolation methods, combined into global table
// Use it like 'Tween.easing.linear'
Tween["easing"] <- {
    linear    = linear,
...
// We should call function in function for overriding from another sources
